...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('kepala_sekolah.absensi-siswa.index') }}">
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('kepala_sekolah.absensi-siswa.index') }}" class="btn btn-secondary">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('kepala_sekolah.absensi-siswa.export-excel', request()->all()) }}" class="btn btn-success btn-sm">
                    <i class="bx bx-download me-1"></i> Export Excel
                </a>
                <a href="{{ route('kepala_sekolah.absensi-siswa.export-pdf', request()->all()) }}" class="btn btn-danger btn-sm">
