            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('nomor_induk') is-invalid @enderror" 
                                       name="nomor_induk" value="{{ old('nomor_induk', $user->nomor_induk) }}" required>
                                @error('nomor_induk')
                        ...
                        <!-- Guru Fields -->
                        <div id="guru-fields" style="display: {{ old('role', $user->role) === 'guru' ? 'block' : 'none' }};">
                            <hr>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('nip') is-invalid @enderror" 
                                           name="nip" value="{{ old('nip', $user->guru->nip ?? '') }}">
                                    @error('nip')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('guru_nama_lengkap') is-invalid @enderror" 
                                           name="guru_nama_lengkap" value="{{ old('guru_nama_lengkap', $user->guru->nama_lengkap ?? '') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="guru_jenis_kelamin" class="form-select @error('guru_jenis_kelamin') is-invalid @enderror">
                                        ...
                                        <option value="L" {{ old('guru_jenis_kelamin', $user->guru->jenis_kelamin ?? '') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="P" {{ old('guru_jenis_kelamin', $user->guru->jenis_kelamin ?? '') == 'P' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="guru_no_hp" value="{{ old('guru_no_hp', $user->guru->no_hp ?? '') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Alamat</label>
                                    <textarea class="form-control" name="guru_alamat" rows="1">{{ old('guru_alamat', $user->guru->alamat ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>

                        <!-- Siswa Fields -->
                        <div id="siswa-fields" style="display: {{ old('role', $user->role) === 'siswa' ? 'block' : 'none' }};">
                            <hr>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('nisn') is-invalid @enderror" 
                                           name="nisn" value="{{ old('nisn', $user->siswa->nisn ?? '') }}">
                                    @error('nisn')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('siswa_nama_lengkap') is-invalid @enderror" 
                                           name="siswa_nama_lengkap" value="{{ old('siswa_nama_lengkap', $user->siswa->nama_lengkap ?? '') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="siswa_jenis_kelamin" class="form-select @error('siswa_jenis_kelamin') is-invalid @enderror">
                                        <option value="">-- Pilih --</option>
                                        <option value="L" {{ old('siswa_jenis_kelamin', $user->siswa->jenis_kelamin ?? '') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="P" {{ old('siswa_jenis_kelamin', $user->siswa->jenis_kelamin ?? '') == 'P' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">No. HP</label>
                                    <input type="text" class="form-control" name="siswa_no_hp" value="{{ old('siswa_no_hp', $user->siswa->no_hp ?? '') }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="form-label">Alamat</label>
                                    <textarea class="form-control" name="siswa_alamat" rows="2">{{ old('siswa_alamat', $user->siswa->alamat ?? '') }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Jabatan</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_ketua_kelas" value="1" 
                                               {{ old('is_ketua_kelas', $user->siswa->is_ketua_kelas ?? false) ? 'checked' : '' }}>
                                        <label class="form-check-label">Ketua Kelas</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_wakil_ketua" value="1" 
                                               {{ old('is_wakil_ketua', $user->siswa->is_wakil_ketua ?? false) ? 'checked' : '' }}>
