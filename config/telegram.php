...
return [
    ...
    */
     'bots' => [
        'mybot' => [
            'username' => 'absensi_guru_man16jakarta_bot',
...
'webhook_secret' => env('TELEGRAM_WEBHOOK_SECRET', 'default-secret'),
    ...
    */
    ...
    // ============================================================================
// 7. UPDATE CONFIG TELEGRAM
// ============================================================================
// config/telegram.php (tambahan)

// Tambahkan di bagian bawah config/telegram.php
/*
|--------------------------------------------------------------------------
| Admin Chat ID for Reports
|--------------------------------------------------------------------------
|
| Chat ID admin untuk menerima laporan harian
|
*/
...
*/
'notifications' => [
    'reminder_minutes' => 15, // Notifikasi X menit sebelum jadwal
    'late_minutes' => 10,     // Notifikasi terlambat setelah X menit
    'auto_alfa_minutes' => 15, // Auto alfa setelah X menit dari jam selesai
],
